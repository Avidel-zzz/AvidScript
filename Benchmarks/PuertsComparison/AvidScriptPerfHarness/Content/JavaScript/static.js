...
function runGameplayScalar(fixture, accumulator, token) {
    return mix(fixture.StaticAddInt32(accumulator, token));
}
...
function runGameplayPropertyBatch4(fixture, accumulator, token0, token1, token2, token3) {
    ...
    fixture.StaticScalarValue = value0;
    fixture.StaticScalarValue = value1;
    fixture.StaticScalarValue = value2;
    fixture.StaticScalarValue = value3;
    return accumulator3;
}
...
function runGameplayObject(fixture, accumulator, token) {
    const result = fixture.StaticObjectRoundtrip(fixture) === fixture ? token : ~token;
    return mix((accumulator ^ result) | 0);
}

function runGameplayEvent(fixture, accumulator, token) {
    return mix(fixture.StaticEventStep(accumulator, token));
}
