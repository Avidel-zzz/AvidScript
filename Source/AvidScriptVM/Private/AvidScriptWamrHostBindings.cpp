...
int64_t EventManagedStateSubscribeV1(wasm_exec_env_t ExecEnv,
	int32_t Slot, int32_t Generation, int32_t Ordinal, int32_t Type, int64_t Object)
{
	FAvidScriptHostCall Call;
	Call.BindingId = EAvidScriptHostBindingId::EventManagedStateSubscribeV1;
	Call.IntArgs[0] = Slot;
	Call.IntArgs[1] = Generation;
...
int64_t EventManagedStateReadV1(wasm_exec_env_t ExecEnv, int32_t Type)
{
	FAvidScriptHostCall Call;
	Call.BindingId = EAvidScriptHostBindingId::EventManagedStateReadV1;
	Call.IntArgs[0] = Type;
	FAvidScriptHostCallResult Result;
	return Dispatch(ExecEnv, StaticImportName(Call.BindingId), Call, Result) ? Result.ReturnValueI64 : 0;
}
...
int32_t LanguageErrorReportV1(wasm_exec_env_t ExecEnv,
	int32_t Type, int32_t Source, int64_t ErrorObject)
{
	FAvidScriptHostCall Call;
	Call.BindingId = EAvidScriptHostBindingId::LanguageErrorReportV1;
	Call.IntArgs[0] = Type;
	Call.IntArgs[1] = Source;
	Call.Int64Args[0] = ErrorObject;
	FAvidScriptHostCallResult Result;
	return Dispatch(ExecEnv, StaticImportName(Call.BindingId), Call, Result) ? Result.ReturnValue : 0;
}

int64_t TaskResultInt32V1(wasm_exec_env_t ExecEnv,
	int32_t Command, int64_t Token, int32_t Argument, int32_t Reserved)
{
	FAvidScriptHostCall Call;
	Call.BindingId = EAvidScriptHostBindingId::TaskResultInt32V1;
	Call.IntArgs[0] = Command;
	Call.Int64Args[0] = Token;
	Call.IntArgs[1] = Argument;
	Call.IntArgs[2] = Reserved;
	FAvidScriptHostCallResult Result;
	return Dispatch(ExecEnv, StaticImportName(Call.BindingId), Call, Result)
		? Result.ReturnValueI64 : 0;
}

int32_t TaskBindProducerV1(wasm_exec_env_t ExecEnv,
	int64_t TaskToken, int64_t ContinuationToken)
{
	FAvidScriptHostCall Call;
	Call.BindingId = EAvidScriptHostBindingId::TaskBindProducerV1;
...
int32_t TaskRetainForContinuationV1(wasm_exec_env_t ExecEnv,
	int64_t TaskToken, int64_t ContinuationToken)
{
	FAvidScriptHostCall Call;
	Call.BindingId = EAvidScriptHostBindingId::TaskRetainForContinuationV1;
	Call.Int64Args[0] = TaskToken;
	Call.Int64Args[1] = ContinuationToken;
	FAvidScriptHostCallResult Result;
	return Dispatch(ExecEnv, StaticImportName(Call.BindingId), Call, Result)
...
int32_t TaskFaultLanguageErrorV1(wasm_exec_env_t ExecEnv,
