...
internal static class CSharpGuestLambdaTests
{
    public static int Run()
    {
        ...
        Require(!CSharpGuestLowerer.Lower(CSharpGuestSemanticFixture.WithoutDispatch(document) with { SchemaVersion = 21, SemanticVersion = "1.24", ClassTypes = Array.Empty<SemanticClassType>() }, new string('b', 64)).Succeeded,
            "lambda callables must not execute under an older semantic version");
        CSharpGuestLoweringResult previous = CSharpGuestLowerer.Lower(CSharpGuestSemanticFixture.WithoutDispatch(document) with { SchemaVersion = 21, SemanticVersion = "1.25", ClassTypes = Array.Empty<SemanticClassType>() }, new string('b', 64));
        ...
        CSharpGuestLoweringResult previousClosureSchema = CSharpGuestLowerer.Lower(CSharpGuestSemanticFixture.WithoutDispatch(document) with { SchemaVersion = 22, SemanticVersion = "1.26", ClassTypes = Array.Empty<SemanticClassType>() }, new string('b', 64));
