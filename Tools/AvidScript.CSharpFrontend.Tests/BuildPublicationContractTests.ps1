...
Assert-Condition (
    [int]$SeedReportJson.semantic.schema_version -eq 21 -and
    [string]$SeedReportJson.semantic.version -ceq "1.25" -and
    [int]$SeedSemanticJson.schema_version -eq 21 -and
    [string]$SeedSemanticJson.semantic_version -ceq "1.25") `
    "seed publication semantic contract is not 21/1.25"
