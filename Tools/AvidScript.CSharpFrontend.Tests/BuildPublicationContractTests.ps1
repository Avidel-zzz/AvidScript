...
Assert-Condition (
    [int]$SeedReportJson.semantic.schema_version -eq 31 -and
    [string]$SeedReportJson.semantic.version -ceq "1.39" -and
    [int]$SeedSemanticJson.schema_version -eq 31 -and
    [string]$SeedSemanticJson.semantic_version -ceq "1.39") `
    "seed publication semantic contract is not 31/1.39"
