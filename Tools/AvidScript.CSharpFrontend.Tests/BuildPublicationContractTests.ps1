...
Assert-Condition (
    [int]$SeedReportJson.semantic.schema_version -eq 22 -and
    [string]$SeedReportJson.semantic.version -ceq "1.26" -and
    [int]$SeedSemanticJson.schema_version -eq 22 -and
    [string]$SeedSemanticJson.semantic_version -ceq "1.26") `
    "seed publication semantic contract is not 22/1.26"
