...
Assert-Condition ($SemanticJson.schema_version -eq 19) "semantic artifact schema version is not 19"
Assert-Condition ($SemanticJson.semantic_version -eq "1.21") "semantic artifact version is not 1.21"
