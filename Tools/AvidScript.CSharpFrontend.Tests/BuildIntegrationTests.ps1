...
Assert-Condition ($SemanticJson.schema_version -eq 7) "semantic artifact schema version is not 7"
Assert-Condition ($SemanticJson.semantic_version -eq "1.7") "semantic artifact version is not 1.7"
