...
Assert-Condition ($SemanticJson.schema_version -eq 31) "semantic artifact schema version is not 30"
Assert-Condition ($SemanticJson.semantic_version -eq "1.39") "semantic artifact version is not 1.39"
