...
Assert-Condition ($SemanticJson.schema_version -eq 20) "semantic artifact schema version is not 20"
Assert-Condition ($SemanticJson.semantic_version -eq "1.22") "semantic artifact version is not 1.22"
