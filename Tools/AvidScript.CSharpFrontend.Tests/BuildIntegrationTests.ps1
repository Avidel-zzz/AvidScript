...
Assert-Condition ($SemanticJson.schema_version -eq 21) "semantic artifact schema version is not 21"
Assert-Condition ($SemanticJson.semantic_version -eq "1.25") "semantic artifact version is not 1.25"
