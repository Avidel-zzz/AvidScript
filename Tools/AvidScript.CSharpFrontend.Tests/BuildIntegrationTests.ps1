...
Assert-Condition ($SemanticJson.schema_version -eq 18) "semantic artifact schema version is not 18"
Assert-Condition ($SemanticJson.semantic_version -eq "1.20") "semantic artifact version is not 1.20"
