...
Assert-Condition (
    [int]$PreparedReportJson.semantic.schema_version -eq 18 -and
    [string]$PreparedReportJson.semantic.version -ceq "1.20" -and
    [int]$PreparedSemanticModel.schema_version -eq 18 -and
    [string]$PreparedSemanticModel.semantic_version -ceq "1.20") `
    "prepared semantic contract is not 18/1.20"
