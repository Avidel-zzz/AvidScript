...
Assert-Condition (
    [int]$PreparedReportJson.semantic.schema_version -eq 21 -and
    [string]$PreparedReportJson.semantic.version -ceq "1.25" -and
    [int]$PreparedSemanticModel.schema_version -eq 21 -and
    [string]$PreparedSemanticModel.semantic_version -ceq "1.25") `
    "prepared semantic contract is not 21/1.25"
