...
Assert-Condition (
    [int]$PreparedReportJson.semantic.schema_version -eq 11 -and
    [string]$PreparedReportJson.semantic.version -ceq "1.11" -and
    [int]$PreparedSemanticModel.schema_version -eq 11 -and
    [string]$PreparedSemanticModel.semantic_version -ceq "1.11") `
    "prepared semantic contract is not 11/1.11"
