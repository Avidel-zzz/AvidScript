...
Assert-Condition (
    ...
    [string]$PreparedReportJson.semantic.version -ceq "1.24" -and
    [int]$PreparedSemanticModel.schema_version -eq 21 -and
    [string]$PreparedSemanticModel.semantic_version -ceq "1.24") `
    "prepared semantic contract is not 21/1.24"
