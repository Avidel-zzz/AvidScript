...
public static class GuestModuleValidator
{
    ...
    public const string CurrentIrVersion = "1.13";
    ...
    private static void ValidateHeader(GuestValidationContext context)
    {
        ...
        bool isTaskLanguageErrorVersion = module.SchemaVersion == GuestTaskLanguageErrorValidator.SchemaVersion
        ...
        bool isLegacyVersion = (module.SchemaVersion == LegacySchemaVersion
            ...
            || (module.SchemaVersion == 7 && module.IrVersion == "1.6")
            || (module.SchemaVersion == 8 && module.IrVersion == "1.7")
            || (module.SchemaVersion == 9 && module.IrVersion == "1.8")
            || (module.SchemaVersion == 10 && module.IrVersion == "1.9")
        ...
        if ((!isCurrentVersion && !isOutcomeVersion && !isOutcomeFlowVersion
                ...
                && !isTaskLocalVersion && !isTaskLanguageErrorVersion && !isLegacyVersion)
