...
internal static class SemanticOperationTests
{
    ...
    private static void OperationSchemaVersionIsExplicit()
    {
        ...
        Assert(document.SchemaVersion == 25, "current artifacts should use semantic schema v25");
        Assert(document.SemanticVersion == "1.29", "current artifacts should advertise semantic version 1.29");
    }
