...
internal static class SemanticDispatchTests
{
    public static int Run()
    {
        ...
        int count = 0;
        Check(document.SchemaVersion == 25 && document.SemanticVersion == "1.29", "dispatch has a versioned schema");
        ...
        Check(!SemanticDispatchContractValidator.IsValid(document with { SchemaVersion = 26 }), "future dispatch schema is not implicitly accepted");
        return count;
