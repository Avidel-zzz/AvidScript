...
internal static class SemanticCallableTests
{
    ...
    private static void DataLaneMetadataIsProjectedForMethodsAndAccessors()
    {
        ...
        Assert(document.SchemaVersion == 13 && document.SemanticVersion == "1.13",
            "data-lane metadata should publish semantic schema v13 / version 1.13");
    ...
    private static void GameplayCallbacksAreProjectedAndRooted()
    {
        ...
        Assert(document.SchemaVersion == 13 && document.SemanticVersion == "1.13",
            "gameplay callback artifacts should use schema v13 / semantic version 1.13");
