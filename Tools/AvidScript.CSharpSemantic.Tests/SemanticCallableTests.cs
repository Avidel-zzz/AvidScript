...
internal static class SemanticCallableTests
{
    ...
    private static void DataLaneMetadataIsProjectedForMethodsAndAccessors()
    {
        ...
        Assert(document.SchemaVersion == 31 && document.SemanticVersion == "1.37",
            "data-lane metadata should publish semantic schema v31 / version 1.37");
    ...
    private static void GameplayCallbacksAreProjectedAndRooted()
    {
        ...
        Assert(document.SchemaVersion == 31 && document.SemanticVersion == "1.37",
            "gameplay callback artifacts should use schema v31 / semantic version 1.37");
