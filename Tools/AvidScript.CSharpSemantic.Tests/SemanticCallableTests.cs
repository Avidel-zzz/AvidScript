...
internal static class SemanticCallableTests
{
    ...
    private static void DataLaneMetadataIsProjectedForMethodsAndAccessors()
    {
        ...
        Assert(document.SchemaVersion == 15 && document.SemanticVersion == "1.15",
            "data-lane metadata should publish semantic schema v15 / version 1.15");
    ...
    private static void GameplayCallbacksAreProjectedAndRooted()
    {
        ...
        Assert(document.SchemaVersion == 15 && document.SemanticVersion == "1.15",
            "gameplay callback artifacts should use schema v15 / semantic version 1.15");
