...
internal static class SemanticCallableTests
{
    ...
    private static void DataLaneMetadataIsProjectedForMethodsAndAccessors()
    {
        ...
        Assert(document.SchemaVersion == 21 && document.SemanticVersion == "1.23",
            "data-lane metadata should publish semantic schema v21 / version 1.23");
    ...
    private static void GameplayCallbacksAreProjectedAndRooted()
    {
        ...
        Assert(document.SchemaVersion == 21 && document.SemanticVersion == "1.23",
            "gameplay callback artifacts should use schema v21 / semantic version 1.23");
