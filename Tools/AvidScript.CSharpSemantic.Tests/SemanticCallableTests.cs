...
internal static class SemanticCallableTests
{
    ...
    private static void DataLaneMetadataIsProjectedForMethodsAndAccessors()
    {
        ...
        Assert(document.SchemaVersion == 30 && document.SemanticVersion == "1.36",
            "data-lane metadata should publish semantic schema v30 / version 1.36");
    ...
    private static void GameplayCallbacksAreProjectedAndRooted()
    {
        ...
        Assert(document.SchemaVersion == 30 && document.SemanticVersion == "1.36",
            "gameplay callback artifacts should use schema v30 / semantic version 1.36");
