...
internal static class SemanticCallableTests
{
    ...
    private static void DataLaneMetadataIsProjectedForMethodsAndAccessors()
    {
        ...
        Assert(document.SchemaVersion == 29 && document.SemanticVersion == "1.33",
            "data-lane metadata should publish semantic schema v29 / version 1.33");
    ...
    private static void GameplayCallbacksAreProjectedAndRooted()
    {
        ...
        Assert(document.SchemaVersion == 29 && document.SemanticVersion == "1.33",
            "gameplay callback artifacts should use schema v29 / semantic version 1.33");
