...
internal static class SemanticCallableTests
{
    ...
    private static void DataLaneMetadataIsProjectedForMethodsAndAccessors()
    {
        ...
        Assert(document.SchemaVersion == 26 && document.SemanticVersion == "1.30",
            "data-lane metadata should publish semantic schema v26 / version 1.30");
    ...
    private static void GameplayCallbacksAreProjectedAndRooted()
    {
        ...
        Assert(document.SchemaVersion == 26 && document.SemanticVersion == "1.30",
            "gameplay callback artifacts should use schema v26 / semantic version 1.30");
