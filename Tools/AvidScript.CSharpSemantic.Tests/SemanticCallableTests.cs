...
internal static class SemanticCallableTests
{
    ...
    private static void DataLaneMetadataIsProjectedForMethodsAndAccessors()
    {
        ...
        Assert(document.SchemaVersion == 12 && document.SemanticVersion == "1.12",
            "data-lane metadata should publish semantic schema v12 / version 1.12");
    ...
    private static void GameplayCallbacksAreProjectedAndRooted()
    {
        ...
        Assert(document.SchemaVersion == 12 && document.SemanticVersion == "1.12",
            "gameplay callback artifacts should use schema v12 / semantic version 1.12");
