...
- Semantic schema v3 / semantic version 1.2 is the current typed-operation and CFG contract. Binary, unary, compound, and increment/decrement operations retain stable operator_kind plus checked/lifted/postfix flags.
