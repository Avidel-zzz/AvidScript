...
function Import-AvidScriptCSharpPreparedSemantic {
    ...
    Assert-AvidScriptPreparedSemantic `
        -Condition ([int]$PreparedReport.semantic.schema_version -eq 21 -and
            [string]$PreparedReport.semantic.version -ceq "1.24" -and
            ...
            [int]$SemanticModel.schema_version -eq 21 -and
            [string]$SemanticModel.semantic_version -ceq "1.24" -and
