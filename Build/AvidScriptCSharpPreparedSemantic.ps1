...
function Import-AvidScriptCSharpPreparedSemantic {
    ...
    Assert-AvidScriptPreparedSemantic `
        -Condition ([int]$PreparedReport.semantic.schema_version -eq 6 -and
            [string]$PreparedReport.semantic.version -ceq "1.6" -and
            ...
            [int]$SemanticModel.schema_version -eq 6 -and
            [string]$SemanticModel.semantic_version -ceq "1.6" -and
