...
try {
    ...
    foreach ($Scenario in @('immediate', 'deferred', 'chain', 'arguments', 'combined', 'cleanup', 'cancelled', 'cancelled-chain', 'local')) {
...
Write-Output "AvidScript.TaskIntFixtures: 9/9 generated; directory=$FixtureRoot"
