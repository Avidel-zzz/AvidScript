...
try {
    ...
    foreach ($Scenario in @('immediate', 'deferred', 'chain', 'arguments', 'combined', 'cleanup', 'cancelled', 'cancelled-chain')) {
...
Write-Output "AvidScript.TaskIntFixtures: 8/8 generated; directory=$FixtureRoot"
