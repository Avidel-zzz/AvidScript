...
try {
    ...
    foreach ($Scenario in @('immediate', 'deferred', 'chain', 'arguments', 'combined', 'cleanup', 'cancelled', 'cancelled-chain', 'local', 'parallel')) {
...
Write-Output "AvidScript.TaskIntFixtures: 10/10 generated; directory=$FixtureRoot"
