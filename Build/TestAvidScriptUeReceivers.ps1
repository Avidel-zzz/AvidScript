...
if ($Found -ne 1 -or $Passed.Count -ne 13 -or @($Passed | ForEach-Object { $_.Groups[1].Value } | Select-Object -Unique).Count -ne 13 -or $Failed -ne 0 -or $Complete -ne 1 -or $Exit -lt 1) {
...
Write-Output "AvidScript.UeReceivers.RuntimeAutomation: 13/13 passed; log=$LogPath"
