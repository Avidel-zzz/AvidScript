...
<p>
  ...
  <img alt="Phase 61 P61.B Complete" src="https://img.shields.io/badge/Status-Phase%2061%20P61.B-26A269">
...
| 结构化诊断 | Debug Map v2、同步/async 序列点、C#/WASM/UE crossing 调用栈；Editor Message Log 可点击源码并校验 SHA |
...
序列点及 Editor 可导航调用栈已落地。5 轮矩阵中，无修改、方法体、Binding 与工具链变更的
